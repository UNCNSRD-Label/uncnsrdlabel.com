 ...
 */
const documents = {
  "fragment Global on QueryRoot {\n  ...Menus\n  shop {\n    name\n    paymentSettings {\n      acceptedCardBrands\n      countryCode\n      currencyCode\n      enabledPresentmentCurrencies\n    }\n    shipsToCountries\n  }\n}":
    types.GlobalFragmentDoc,
  ...
  'fragment Menus on QueryRoot {\n  clientServiceMenu: menu(handle: "client-service") {\n    ...MenuInformation\n  }\n  legalMenu: menu(handle: "legal") {\n    ...MenuInformation\n  }\n  mainMenu: menu(handle: "main-menu") {\n    ...MenuInformation\n  }\n}':
    types.MenusFragmentDoc,
  "fragment PolicyBasicInformation on ShopPolicy {\n  body\n  id\n  title\n  url\n}":
    types.PolicyBasicInformationFragmentDoc,
...
export function graphql(
  source: "fragment Global on QueryRoot {\n  ...Menus\n  shop {\n    name\n    paymentSettings {\n      acceptedCardBrands\n      countryCode\n      currencyCode\n      enabledPresentmentCurrencies\n    }\n    shipsToCountries\n  }\n}"
): typeof documents["fragment Global on QueryRoot {\n  ...Menus\n  shop {\n    name\n    paymentSettings {\n      acceptedCardBrands\n      countryCode\n      currencyCode\n      enabledPresentmentCurrencies\n    }\n    shipsToCountries\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
 ...
 */
export function graphql(
  source: 'fragment Menus on QueryRoot {\n  clientServiceMenu: menu(handle: "client-service") {\n    ...MenuInformation\n  }\n  legalMenu: menu(handle: "legal") {\n    ...MenuInformation\n  }\n  mainMenu: menu(handle: "main-menu") {\n    ...MenuInformation\n  }\n}'
): typeof documents['fragment Menus on QueryRoot {\n  clientServiceMenu: menu(handle: "client-service") {\n    ...MenuInformation\n  }\n  legalMenu: menu(handle: "legal") {\n    ...MenuInformation\n  }\n  mainMenu: menu(handle: "main-menu") {\n    ...MenuInformation\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "fragment PolicyBasicInformation on ShopPolicy {\n  body\n  id\n  title\n  url\n}"
): typeof documents["fragment PolicyBasicInformation on ShopPolicy {\n  body\n  id\n  title\n  url\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
