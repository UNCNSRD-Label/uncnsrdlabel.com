...
export type Breakpoint = Entity & Node & {
...
export type LogoCloud = Entity & Node & {
...
export type Newsletter = Entity & Node & {
...
export type PricingPlan = Entity & Node & {
