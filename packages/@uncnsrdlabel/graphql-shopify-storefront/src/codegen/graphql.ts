...
export type PageFragment = { __typename?: 'Page', id: string, title: string, handle: string, body: string, bodySummary: string, createdAt: string, updatedAt: string, seo?: (
    ...
    & { ' $fragmentRefs'?: { 'SeoFragment': SeoFragment } }
        ...
        ) }> } | null } | null, sections?: { __typename?: 'Metafield', references?: { __typename: 'MetafieldReferenceConnection', nodes: Array<{ __typename: 'Collection' } | { __typename: 'GenericFile' } | { __typename: 'MediaImage' } | { __typename: 'Metaobject', handle: string, type: string, updatedAt: string, fields: Array<{ __typename: 'MetaobjectField', key: string, type: string, value?: string | null, reference?: { __typename: 'Collection' } | { __typename: 'GenericFile' } | { __typename: 'MediaImage', id: string, image?: (
              { __typename?: 'Image' }
              & { ' $fragmentRefs'?: { 'ImageFragment': ImageFragment } }
            ) | null } | { __typename: 'Metaobject', handle: string, id: string, type: string, updatedAt: string } | { __typename: 'Page' } | { __typename: 'Product' } | { __typename: 'ProductVariant' } | { __typename: 'Video' } | null, references?: { __typename: 'MetafieldReferenceConnection', nodes: Array<{ __typename: 'Collection' } | { __typename: 'GenericFile' } | { __typename: 'MediaImage' } | { __typename: 'Metaobject', handle: string, id: string, type: string, updatedAt: string, fields: Array<{ __typename: 'MetaobjectField', key: string, type: string, value?: string | null, reference?: { __typename: 'Collection' } | { __typename: 'GenericFile' } | { __typename: 'MediaImage' } | { __typename: 'Metaobject', handle: string, id: string, type: string, updatedAt: string } | { __typename: 'Page' } | { __typename: 'Product' } | { __typename: 'ProductVariant' } | { __typename: 'Video' } | null }> } | { __typename: 'Page' } | { __typename: 'Product' } | { __typename: 'ProductVariant' } | { __typename: 'Video' }> } | null }> } | { __typename: 'Page' } | { __typename: 'Product' } | { __typename: 'ProductVariant' } | { __typename: 'Video' }> } | null } | null } & { ' $fragmentName'?: 'PageFragment' };
