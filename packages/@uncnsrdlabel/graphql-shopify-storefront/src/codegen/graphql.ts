...
export type ProductDetailsFragment = { __typename: 'Product', availableForSale: boolean, description: string, descriptionHtml: string, handle: string, id: string, tags: Array<string>, title: string, updatedAt: string, vendor: string, collections: { __typename?: 'CollectionConnection', edges: Array<{ __typename?: 'CollectionEdge', node: { __typename?: 'Collection', id: string, handle: string, title: string } }> }, compareAtPriceRange: { __typename?: 'ProductPriceRange', maxVariantPrice: { __typename?: 'MoneyV2', amount: string, currencyCode: CurrencyCode }, minVariantPrice: { __typename?: 'MoneyV2', amount: string, currencyCode: CurrencyCode } }, featuredImage?: (
    ...
    { __typename?: 'Metafield' }
    & { ' $fragmentRefs'?: { 'ProductMetafieldsFragment': ProductMetafieldsFragment } }
  ) | null>, options: Array<{ __typename?: 'ProductOption', id: string, name: string, values: Array<string> }>, priceRange: { __typename?: 'ProductPriceRange', maxVariantPrice: { __typename?: 'MoneyV2', amount: string, currencyCode: CurrencyCode }, minVariantPrice: { __typename?: 'MoneyV2', amount: string, currencyCode: CurrencyCode } }, seo: (
    { __typename?: 'SEO' }
    & { ' $fragmentRefs'?: { 'SeoFragment': SeoFragment } }
  ), variants: (
    { __typename?: 'ProductVariantConnection' }
