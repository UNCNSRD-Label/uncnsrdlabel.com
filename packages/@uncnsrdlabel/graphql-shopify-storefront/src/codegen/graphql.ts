...
export type PageSectionModuleFragment = { __typename?: 'Metaobject', handle: string, id: string, type: string, updatedAt: string, fields: Array<{ __typename: 'MetaobjectField', key: string, type: string, value?: string | null, reference?: { __typename: 'Collection' } | { __typename: 'GenericFile' } | { __typename: 'MediaImage', image?: (
        { __typename?: 'Image' }
        & { ' $fragmentRefs'?: { 'ImageFragment': ImageFragment } }
      ) | null } | { __typename: 'Metaobject', handle: string, id: string, type: string, updatedAt: string } | { __typename: 'Page' } | { __typename: 'Product' } | { __typename: 'ProductVariant' } | { __typename: 'Video' } | null, references?: { __typename?: 'MetafieldReferenceConnection', edges: Array<{ __typename?: 'MetafieldReferenceEdge', node: { __typename: 'Collection' } | { __typename: 'GenericFile' } | { __typename: 'MediaImage', image?: (
            { __typename?: 'Image' }
            & { ' $fragmentRefs'?: { 'ImageFragment': ImageFragment } }
