...
export type CollectionBasicInformationFragment = {
  __typename?: 'Collection'
  description: string
  handle: string
  id: string
...
} & { ' $fragmentName'?: 'CollectionBasicInformationFragment' }
...
export type MenuInformationFragment = {
  __typename?: 'Menu'
  handle: string
  id: string
  itemsCount: number
  ...
  items: Array<
    { __typename?: 'MenuItem' } & {
      ' $fragmentRefs'?: {
        MenuItemInformationFragment: MenuItemInformationFragment
      }
    }
  >
} & { ' $fragmentName'?: 'MenuInformationFragment' }

export type MenuItemInformationFragment = {
  __typename?: 'MenuItem'
  id: string
...
} & { ' $fragmentName'?: 'ProductBasicInformationFragment' }

export type ProductVariantBasicInformationFragment = {
  __typename?: 'ProductVariant'
  availableForSale: boolean
  ...
  collection?: {
    ...
    products: {
      ...
      nodes: Array<
        { __typename?: 'Product' } & {
          ' $fragmentRefs'?: {
            ProductBasicInformationFragment: ProductBasicInformationFragment
          }
        }
      >
    }
  ...
  collections: {
    ...
    edges: Array<{
      ...
      node: { __typename?: 'Collection' } & {
        ' $fragmentRefs'?: {
          CollectionBasicInformationFragment: CollectionBasicInformationFragment
        }
      }
    }>
...
export type CollectionsPathsQueryVariables = Exact<{
  country: CountryCode
  first?: InputMaybe<Scalars['Int']>
}>

export type CollectionsPathsQuery = {
  __typename?: 'QueryRoot'
  collections: {
    __typename?: 'CollectionConnection'
...
export type ProductsByNodeIdQueryVariables = Exact<{
  country: CountryCode
  ids: Array<Scalars['ID']> | Scalars['ID']
}>

export type ProductsByNodeIdQuery = {
  __typename?: 'QueryRoot'
  nodes: Array<
    | { __typename?: 'AppliedGiftCard' }
    | { __typename?: 'Article' }
...
export type ProductsPathsQueryVariables = Exact<{
  country: CountryCode
}>

export type ProductsPathsQuery = {
  __typename?: 'QueryRoot'
  products: {
    __typename?: 'ProductConnection'
    nodes: Array<{ __typename?: 'Product'; handle: string }>
  }
}
...
export const CollectionBasicInformationFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'CollectionBasicInformation' },
      typeCondition: {
        kind: 'NamedType',
                    ...
                    },
                    {
                      ...
                      fields: [
                        ...
                        },
                        {
                          ...
                          value: {
                            kind: 'StringValue',
                            value: 'collection_box_shadow_colour',
                            block: false,
                          },
                        },
                      ],
...
} as unknown as DocumentNode<CollectionBasicInformationFragment, unknown>
export const ProductBasicInformationFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'ProductBasicInformation' },
      typeCondition: {
        kind: 'NamedType',
      ...
      selectionSet: {
        ...
        selections: [
                    ...
                    selections: [
                      {
                        ...
                        typeCondition: {
                          kind: 'NamedType',
                          name: { kind: 'Name', value: 'MetafieldReference' },
                        },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'onlineStoreUrl' } },
          {
            kind: 'Field',
...
} as unknown as DocumentNode<ProductBasicInformationFragment, unknown>
export const ProductVariantBasicInformationFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
...
>
export const CollectionProductsByHandleDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'CollectionProductsByHandle' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
...
export const CollectionsDocument = {
  ...
  definitions: [
                          ...
                          selections: [
                            {
                              ...
                              name: {
                                kind: 'Name',
                                value: 'CollectionBasicInformation',
                              },
                            },
                          ],
                        },
    ...
    ...CollectionBasicInformationFragmentDoc.definitions,
  ],
} as unknown as DocumentNode<CollectionsQuery, CollectionsQueryVariables>
export const CollectionsPathsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'CollectionsPaths' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
  ...
  CollectionsPathsQuery,
  CollectionsPathsQueryVariables
>
...
export const PageByHandleDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
...
} as unknown as DocumentNode<PageByHandleQuery, PageByHandleQueryVariables>
...
export const ProductByHandleDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'ProductByHandle' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
                      ...
                      },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'requiresShipping' },
                            },
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'selectedOptions' },
...
export const ProductsByNodeIdDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'ProductsByNodeId' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
                    ...
                    selections: [
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'onlineStoreUrl' },
                            },
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'priceRange' },
  ...
  ProductsByNodeIdQueryVariables
>
export const ProductsPathsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'ProductsPaths' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
...
} as unknown as DocumentNode<ProductsPathsQuery, ProductsPathsQueryVariables>
export const VendorsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
...
} as unknown as DocumentNode<VendorsQuery, VendorsQueryVariables>
