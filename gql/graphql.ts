...
export type ProductQuery = { __typename?: 'QueryRoot', product?: { __typename?: 'Product', id: string, handle: string, availableForSale: boolean, title: string, productType: string, publishedAt: string, vendor: string, description: string, descriptionHtml: string, seo: { __typename?: 'SEO', title?: string | null, description?: string | null }, options: Array<{ __typename?: 'ProductOption', id: string, name: string, values: Array<string> }>, priceRange: { __typename?: 'ProductPriceRange', maxVariantPrice: { __typename?: 'MoneyV2', amount: string, currencyCode: CurrencyCode }, minVariantPrice: { __typename?: 'MoneyV2', amount: string, currencyCode: CurrencyCode } }, variants: { __typename?: 'ProductVariantConnection', pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean }, nodes: Array<{ __typename?: 'ProductVariant', barcode?: string | null, id: string, title: string, sku?: string | null, availableForSale: boolean, currentlyNotInStock: boolean, quantityAvailable?: number | null, requiresShipping: boolean, selectedOptions: Array<{ __typename?: 'SelectedOption', name: string, value: string }>, price: { __typename?: 'MoneyV2', amount: string, currencyCode: CurrencyCode } }> }, images: { __typename?: 'ImageConnection', nodes: Array<{ __typename?: 'Image', altText?: string | null, height?: number | null, url: string, width?: number | null }> } } | null };
