...
const contentSecurityPolicyComponents = [
  `base-uri 'self'`,
  // `connect-src 'self' *.clarity.ms *.facebook.com *.facebook.net *.klaviyo.com c.bing.com cdn.contentful.com fonts.googleapis.com fonts.gstatic.com images.ctfassets.net stats.g.doubleclick.net vitals.vercel-insights.com www.google-analytics.com www.googletagmanager.com ${domains}`,
  `connect-src *`,
