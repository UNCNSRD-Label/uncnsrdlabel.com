...
const contentSecurityPolicyComponents = [
  ...
  `frame-src 'self' placement-api.afterpay.com td.doubleclick.net vercel.live www.facebook.com ${domains}`,
  `img-src 'self' data: *.clarity.ms *.facebook.com *.facebook.net *.klaviyo.com *.skimresources.com assets.tidiochat.com assets.vercel.com c.bing.com cdnjs.cloudflare.com/ajax/libs/twemoji/ cdn.jsdelivr.net/gh/lipis/flag-icons/flags/ cdn.shopify.com fonts.gstatic.com googleads.g.doubleclick.net heapanalytics.com s3.amazonaws.com/bp9hssvzhoimfzyehfletkb8havpgjc2/conversation/ s3.amazonaws.com/tidio-files/ s3-eu-west-1.amazonaws.com/hj-insights script.hotjar.com vercel.com site-assets.afterpay.com/assets/ ${googleSupportedDomains.map(domain => `www${domain}`).join(' ')} images.ctfassets.net tidio-images-messenger.s3.amazonaws.com www.google-analytics.com www.googletagmanager.com`,
