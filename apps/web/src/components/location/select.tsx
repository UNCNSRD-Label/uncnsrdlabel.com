...
export function LocationSelect({className, setOpen}: {
    className?: string;
}) {
    ...
    const submit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        setLangSettings(consentParams.lang);
        setOpen(false);
    };
                          ...
                          (local, i) => {
                              ...
                              <SelectPrimitive.Item
                                  ...
                                  className={cn(
                                      ...
                                      "focus:outline-none select-none bg-blue-100"
                                  )}
                              >
                                  <SelectPrimitive.ItemText>{intl.formatMessage({ id: `lang-${local.lang}` })}</SelectPrimitive.ItemText>
