...
export function ProductMedia({
  ...
  return (
    <div
      className="ghost-scrollbar absolute z-0 col-span-full grid w-full snap-both snap-mandatory grid-flow-col justify-start overflow-x-scroll scroll-smooth h-fit"
      id="images"
    >
      <Images
