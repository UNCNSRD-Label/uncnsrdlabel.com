...
export async function addAddressAction(_currentState: any, formData: FormData) {
  ...
  try {
    const customerAddressCreateMutationResponse = await getShopifyGraphQL(
      customerAddressCreateMutation,
      variables,
    );

    const errors =
      customerAddressCreateMutationResponse.customerAddressCreate
        ?.customerUserErrors;
...
export async function deleteAddressAction(
  ...
  try {
    const customerAddressDeleteMutationResponse = await getShopifyGraphQL(
      customerAddressDeleteMutation,
      variables,
    );

    const errors =
      customerAddressDeleteMutationResponse.customerAddressDelete
        ?.customerUserErrors;
...
export async function updateAddressAction(
  ...
  try {
    const customerAddressUpdateMutationResponse = await getShopifyGraphQL(
      customerAddressUpdateMutation,
      variables,
    );

    const errors =
      customerAddressUpdateMutationResponse.customerAddressUpdate
        ?.customerUserErrors;
...
export async function setDefaultAddressAction(
  ...
  try {
    const customerDefaultAddressUpdateMutationResponse =
      await getShopifyGraphQL(customerDefaultAddressUpdateMutation, variables);

    const errors =
      customerDefaultAddressUpdateMutationResponse.customerDefaultAddressUpdate
        ?.customerUserErrors;
