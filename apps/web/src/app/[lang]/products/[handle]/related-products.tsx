...
export async function RelatedProducts({
  ...
  return (
    <aside className={cn("px-4 pb-40 pt-12", className)}>
      ...
      <Grid className="grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 [&>*:nth-of-type(3)]:hidden [&>*:nth-of-type(3)]:lg:list-item [&>*:nth-of-type(4)]:hidden [&>*:nth-of-type(4)]:xl:list-item [&>*:nth-of-type(5)]:hidden">
        <ProductGridItems
          lang={lang}
          limit={4}
