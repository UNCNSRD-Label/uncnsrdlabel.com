...
export default async function PoliciesPage({
  ...
  return (
    <>
      <Prose
        className="prose-sm prose-thead:border-hotPink prose-tr:border-hotPink [&_table_tr]:grid sm:[&_table_tr]:table-row bg-opaque-white px-6 sm:p-8 min-w-full sm:fill-light sm:max-w-[48rem] sm:order-2 sm:mb-32 overflow-x-auto"
