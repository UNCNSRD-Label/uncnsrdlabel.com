...
export default async function AccountLayout({
  ...
  return (
    <div className="sm:bg-dark bg-light relative grid max-w-[100dvw] gap-x-8 gap-y-4 pt-[calc(theme(spacing.safeTop)_+_theme(spacing.16))] sm:bg-[url('/images/backgrounds/MAV7957-Edit.jpg')] sm:bg-cover sm:bg-fixed sm:px-8 md:grid-cols-[1fr_3fr] md:[grid-template-areas:'start_main_end'] lg:grid-cols-[1fr_fit-content(48rem)_1fr]">
      <main
        className={cn(
