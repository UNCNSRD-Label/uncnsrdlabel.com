...
export default async function AccountLayout({
  ...
  return (
    <div className="relative z-40">
      <Navbar lang={lang} />
      <div className="sm:bg-dark grid max-w-[100dvw] gap-x-8 gap-y-4 bg-cover bg-fixed pt-16 sm:grid-cols-[1fr_3fr] sm:bg-[url('/images/backgrounds/MAV7957-Edit.jpg')] sm:px-8 sm:pt-16 sm:[grid-template-areas:'start_main'] lg:grid-cols-[1fr_48rem_1fr] lg:[grid-template-areas:'start_main_end']">
